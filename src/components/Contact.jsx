...
import { FaEnvelope, FaFacebook, FaGithub, FaLinkedin, FaMapMarkedAlt, FaMapMarkerAlt, FaPhone, FaWhatsapp } from 'react-icons/fa'
                ...
                <div className='space-y-8 mt-2'>
                  <div className='flex items-start'>
                   ...
                   <div>
                    ...
                    <p className='text-gray-400'>Bahawal Nager</p>
                   </div>
                  </div>
                  <div className='flex items-start'>
                   <div className='text-purple-600 text-2xl mr-4'>
                  ...
                  <div className='flex items-start'>
                   ...
                   <div>
                    ...
                    <p className='text-gray-400'>+92 000000000</p>
                   </div>
                  </div>
                  <div className='pt-4'>
                    ...
                    <div className='flex space-x-4'>
                        ...
                        className='w-12 h-12 rounded-full bg-gray-600 flex items-center justify-center text-purple-500 hover:bg-purple-700 hover:text-white transition duration-300'>
                         ...
                         <a href="https://www.linkedin.com/in/umer-nazir-589a82339/"
                         target='_blank'
                         rel='noopener noreferrer'
                         ...
                         <a href="#" className='w-12 h-12 rounded-full bg-gray-600 flex items-center justify-center text-blue-500 hover:bg-purple-700 hover:text-white transition duration-300'>
                         <FaFacebook className='size-8'/>
                        </a>
                         <a href="https://wa.me/923156849556?text=Hello%20Umer!%20I%20saw%20your%20portfolio%20and%20wanted%20to%20connect.
                         "target="_blank"
                          rel="noopener noreferrer"
