    ...
    <div className='bg-gray-700 rounded-2xl overflow-hidden hover:translate-y-2 transition duration-300 cursor-pointer'>
      ...
      <div className='p-6'>
        ...
        <div className='flex flex-wrap gap-2 mb-4'>
          {tech.map((item, index) => (
            <span key={index} className='px-3 py-1 bg-gray-400 rounded-full text-sm'>
              {item}
            </span>
          ))}
        </div>
        ...
        <div className='flex gap-2'>
          <a
            ...
            className='flex-1 text-center px-4 py-2 bg-purple-500 rounded-lg
          ...
          <a
            ...
            target='_blank'
            rel='noopener noreferrer'
            className='flex-1 text-center px-4 py-2 border border-purple-500 rounded-lg
                       font-medium hover:bg-purple-700 transition duration-300'
          >
            View Code
          </a>
